// $Header: /cvsshare/content/cvsroot/cdecurate/WebRoot/js/xaramenu.js,v 1.2 2009-04-09 17:51:57 hebell Exp $
...
main=dir;
if(main==1||main==2){
document.write("<table border=\"0\" cellspacing=\""+space+"\" cellpadding=\"0\">");
}
if(file!==""){
al="";
if(align==1){
...
if(tar!==""){
document.write("target=\""+tar+"\" ");
}
document.write("onmouseout=\"");
if(dir>0){
document.write("tidyMenu(event);");
}
document.write("\" onmouseover=\"");
if(dir>0){
document.write("openMenu(event, '"+name+"',"+dir+","+bc+","+fc+");");
}
...
if(!isgraphic){
document.write(" class=\""+s+"\" style=\"width:"+(w>0?w:menuw)+"px\"");
}
document.write(">");
if(isgraphic){
...
document.write("<div id=\""+name+"\" class=\""+style+"\"  style=\"width:"+(menuw+(NS7?bd*2:0))+"px\">");
}
...
document.write("</div>");
if(!NS7){
document.getElementById(name).onmouseout=tidyMenu;
}
}
