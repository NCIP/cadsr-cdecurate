...
public class ObjMenuTag extends MenuTag {
	...
	public int doEndTag() throws JspException {
		...
		if (selACType != null) {
			try {
				...
				objMenu.println("<tr><td colspan=\"2\"><p style=\"margin: 0px 0px 5px 0px; color: red\"><span id=\"selCnt\">" + rowsChecked + "</span> Record(s) Selected</p></td><td align=\"right\" valign=\"top\"><span style=\"border: 1px solid black; padding: 0.5px 1px 0.5px 1px;cursor:default;\">x</span></td></tr>");
	...
	public String displayHideAll(){
		String tag = generateTR("","","","minus_12","hideShowAllDef(false)","Contract All Definitions");
		return tag;	
	}
