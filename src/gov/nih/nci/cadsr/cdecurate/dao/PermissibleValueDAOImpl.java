...
public class PermissibleValueDAOImpl extends JdbcDaoSupport
		implements PermissibleValueDAO {
	...
	public PermissibleValueDAOImpl() {
	...
	@Override
	public List<PermissibleValueBean> getPermissibleValuesByValueDomainId(
			String id) {
