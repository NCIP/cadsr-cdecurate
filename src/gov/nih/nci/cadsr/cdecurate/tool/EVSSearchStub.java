...
// $Header: /cvsshare/content/cvsroot/cdecurate/src/gov/nih/nci/cadsr/cdecurate/tool/EVSSearchStub.java,v 1.6 2007-06-01 22:17:44 hegdes Exp $
...
public class EVSSearchStub implements Serializable
{
     ...
     */
    public EVSSearchStub(HttpServletRequest req, HttpServletResponse res, NCICurationServlet CurationServlet)
    {
        logger.debug("here");
    }
