...
<s:div cssClass="result ui-widget-content ui-corner-all">
	...
	<s:form id="newPvForm" action="permissibleValueAction" target="_blank">
		...
		<sj:datepicker id="beginDate" name="beginDate" 
			label="Begin Date" required="true" />
	...
	<sj:dialog id="vmOptionDialog" autoOpen="false" modal="true"
	...
	<table>
		<tr>
			...
			<td><sj:div id="searchVmOptions">
					<sj:a openDialog="vmOptionDialog"
	...
	<img id="indicator" src="images/indicator.gif" alt="Loading..."
		style="display: none" />
	<s:url id="pvTableUrl" action="addPv" />
	<sj:a id="addPvButton" href="%{pvTableUrl}"
		targets="existingPVs" listenTopics="existingPVs"
		button="true" buttonIcon="ui-icon-gear"
