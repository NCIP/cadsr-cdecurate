...
<sj:div id="newVmFromConceptDiv"
	...
	<div
		...
		<span id="ui-dialog-title-alertDialog" class="ui-dialog-title">Create
			New VM from the Selected Concept</span>
	</div>
	<br>
	<sj:div id="vmInfoDiv">
		<s:form id="editVmForm" action="ValueMeaningAction" target="_blank">
			...
			<sj:dialog id="searchConceptForVm2" autoOpen="false" modal="false"
				...
				height="600" width="1200" position="center"
    	...
    	Search New Concept
			...
			<tr>
				...
				<s:set name="secondVmCheck" scope="session">${param.secondVmCheck}</s:set>
