/* Copyright ScenPro, Inc, 2005
   ...
   $Header: /cvsshare/content/cvsroot/cdecurate/conf/stage/update_tool_options_url.sql,v 1.1 2006-03-22 22:22:12 hardingr Exp $
...
SET value = 'http://cabio-stage.nci.nih.gov/cacore31/http/remoteService'
...
UPDATE sbrext.tool_options_view_ext 
SET value = 'http://cdebrowser-stage.nci.nih.gov'
WHERE tool_name = 'BROWSER' AND property = 'URL'; 

--Store url for curation tool if needed.
UPDATE sbrext.tool_options_view_ext 
SET value = 'http://cdecurate-stage.nci.nih.gov'
...
UPDATE sbrext.tool_options_view_ext 
SET value = 'http://cdecurate-stage.nci.nih.gov/filecache/'
