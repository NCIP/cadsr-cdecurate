...
union select 'BROWSER' as tool_name, 'URL' as property, 'http://cdebrowser-stage.nci.nih.gov' as value, 'Store browser url cde browser' as description from dual
union select 'EVS' as tool_name, 'URL' as property, 'http://cabio-stage.nci.nih.gov/cacore32/http/remoteService' as value, 'Store evs url specific to the evs server' as description from dual
