/* Copyright ScenPro, Inc, 2005
   ...
   $Header: /cvsshare/content/cvsroot/cdecurate/conf/stage/load_tool_options.sql,v 1.6 2006-03-02 23:17:56 hardingr Exp $
...
--Store evs alternate url specific to curation tool if needed.
INSERT INTO sbrext.tool_options_view_ext (tool_name, property, value, description)
VALUES ('CURATION', 'EVS.URL', 'http://cbioapp101.nci.nih.gov:49080/cacore31/http/remoteService', 
	   'Store evs alternate url specific to curation tool if needed');
