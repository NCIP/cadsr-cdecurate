/* Copyright ScenPro, Inc, 2005
   ...
   $Header: /cvsshare/content/cvsroot/cdecurate/conf/sandbox/load_tool_options.sql,v 1.28 2007-05-29 19:19:38 hebell Exp $
...
union select 'BROWSER' as tool_name, 'URL' as property, 'http://cdebrowser-sandbox.nci.nih.gov' as value, 'Store browser url cde browser' as description from dual
...
VALUES ('CURATION', 'URL', 'http://cdecurate-sandbox.nci.nih.gov', 
