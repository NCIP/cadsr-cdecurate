/* Copyright ScenPro, Inc, 2005
   ...
   $Header: /cvsshare/content/cvsroot/cdecurate/conf/sandbox/update_tool_options_url.sql,v 1.10 2006-11-15 04:59:04 hegdes Exp $
...
UPDATE sbrext.tool_options_view_ext 
SET value = 'http://cdebrowser-sandbox.nci.nih.gov'
WHERE tool_name = 'BROWSER' AND property = 'URL'; 

--Store url for curation tool if needed.
UPDATE sbrext.tool_options_view_ext 
SET value = 'http://cdecurate-sandbox.nci.nih.gov'
...
UPDATE sbrext.tool_options_view_ext 
SET value = 'http://cdecurate-sandbox.nci.nih.gov/filecache/'
