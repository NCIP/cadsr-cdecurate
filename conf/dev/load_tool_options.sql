/* Copyright ScenPro, Inc, 2005
   ...
   $Header: /cvsshare/content/cvsroot/cdecurate/conf/dev/load_tool_options.sql,v 1.1 2006-02-08 19:40:21 hegdes Exp $
...
VALUES ('ALL', 'EVS.URL', 'http://cbioqa101.nci.nih.gov:49080/cacore31/http/remoteService', 
...
insert into sbrext.tool_options_view_ext (tool_name, property, value, description)
values ('CURATION', 'REFDOC_FILECACHE', '/local/content/cadsrsentinel/reports/',
'Ref doc file cache for uploading blobs from the DB to the web server to create url.');


--Ref doc file url. This is the prefix url for building the file anchor tag for files uploaded to the file cache.
insert into sbrext.tool_options_view_ext (tool_name, property, value, description)
values ('CURATION', 'REFDOC_FILEURL', 'http://cadsrsentinel-dev.nci.nih.gov/AlertReports/',
'Ref doc file url. This is the prefix url for building the file anchor tag for files uploaded to the file cache.');  
