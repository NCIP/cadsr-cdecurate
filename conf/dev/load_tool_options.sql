/* Copyright ScenPro, Inc, 2005
   ...
   $Header: /cvsshare/content/cvsroot/cdecurate/conf/dev/load_tool_options.sql,v 1.43 2007-05-29 19:19:38 hebell Exp $
...
union select 'BROWSER' as tool_name, 'URL' as property, 'http://cdebrowser-dev.nci.nih.gov' as value, 'Store browser url cde browser' as description from dual
union select 'EVS' as tool_name, 'URL' as property, 'http://cabio-dev.nci.nih.gov/cacore32/http/remoteService' as value, 'Store evs url specific to the evs server' as description from dual
...
insert into sbrext.tool_options_view_ext (tool_name, property, value, description)
values ('CURATION', 'REFDOC_FILEURL', 'http://cdecurate-dev.nci.nih.gov/filecache/',
'Ref doc file url. This is the prefix url for building the file anchor tag for files uploaded to the file cache.');  
