/* Copyright ScenPro, Inc, 2005
   ...
   $Header: /cvsshare/content/cvsroot/cdecurate/conf/qa/load_tool_options.sql,v 1.43 2007-05-29 19:19:38 hebell Exp $
...
union select 'BROWSER' as tool_name, 'URL' as property, 'http://cdebrowser-qa.nci.nih.gov' as value, 'Store browser url cde browser' as description from dual
union select 'EVS' as tool_name, 'URL' as property, 'http://cabio-qa.nci.nih.gov/cacore32/http/remoteService' as value, 'Store evs url specific to the evs server' as description from dual
...
--Store evs alternate url specific to curation tool if needed.
INSERT INTO sbrext.tool_options_view_ext (tool_name, property, value, description)
VALUES ('CURATION', 'EVS.URL', 'http://cabio-qa.nci.nih.gov/cacore32/http/remoteService', 
	   'Store evs alternate url specific to curation tool if needed');
*/
