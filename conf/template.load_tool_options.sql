...
MERGE INTO SBREXT.TOOL_OPTIONS_VIEW_EXT S
USING (
SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.01' AS PROPERTY, 'C25417' AS VALUE, 'Amount' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.02' AS PROPERTY, 'C13717' AS VALUE, 'Anatomic Site' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.03' AS PROPERTY, 'C25372' AS VALUE, 'Category' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.04' AS PROPERTY, 'C25162' AS VALUE, 'Code' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.05' AS PROPERTY, 'C25463' AS VALUE, 'Count' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.06' AS PROPERTY, 'C25164' AS VALUE, 'Date' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.07' AS PROPERTY, 'C37939' AS VALUE, 'Date/Time' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.08' AS PROPERTY, 'C25488' AS VALUE, 'Dose' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.09' AS PROPERTY, 'C25330' AS VALUE, 'Duration' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.10' AS PROPERTY, 'C48150' AS VALUE, 'Float' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.11' AS PROPERTY, 'C25515' AS VALUE, 'Frequency' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.12' AS PROPERTY, 'C18000' AS VALUE, 'Grade' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.13' AS PROPERTY, 'C25364' AS VALUE, 'Identifier' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.14' AS PROPERTY, 'C38147' AS VALUE, 'Ind-2' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.15' AS PROPERTY, 'C38148' AS VALUE, 'Ind-3' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.16' AS PROPERTY, 'C25180' AS VALUE, 'Indicator' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.17' AS PROPERTY, 'C45255' AS VALUE, 'Integer' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.18' AS PROPERTY, 'C25543' AS VALUE, 'Interval' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.19' AS PROPERTY, 'C25209' AS VALUE, 'Measurement' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.20' AS PROPERTY, 'C25191' AS VALUE, 'Name' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.21' AS PROPERTY, 'C42614' AS VALUE, 'Name' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.22' AS PROPERTY, 'C25337' AS VALUE, 'Number' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.23' AS PROPERTY, 'C25218' AS VALUE, 'Procedure' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.24' AS PROPERTY, 'C38013' AS VALUE, 'Range' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.25' AS PROPERTY, 'C25636' AS VALUE, 'Rate' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.26' AS PROPERTY, 'C25638' AS VALUE, 'Reason' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.27' AS PROPERTY, 'C20200' AS VALUE, 'Result' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.28' AS PROPERTY, 'C25664' AS VALUE, 'Scale' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.29' AS PROPERTY, 'C25338' AS VALUE, 'Score' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.30' AS PROPERTY, 'C25683' AS VALUE, 'Source' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.31' AS PROPERTY, 'C25685' AS VALUE, 'Specify' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.32' AS PROPERTY, 'C16899' AS VALUE, 'Stage' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.33' AS PROPERTY, 'C25688' AS VALUE, 'Status' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.34' AS PROPERTY, 'C25704' AS VALUE, 'Text' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.35' AS PROPERTY, 'C25207' AS VALUE, 'Time' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.36' AS PROPERTY, 'C25284' AS VALUE, 'Type' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.37' AS PROPERTY, 'C25709' AS VALUE, 'Unit of Measure' AS DESCRIPTION FROM DUAL
UNION SELECT 'CURATION' AS TOOL_NAME, 'REPTERM.PRICON.38' AS PROPERTY, 'C25712' AS VALUE, 'Value' AS DESCRIPTION FROM DUAL
)T
ON(S.TOOL_NAME = T.TOOL_NAME AND S.PROPERTY = T.PROPERTY)
WHEN MATCHED THEN
