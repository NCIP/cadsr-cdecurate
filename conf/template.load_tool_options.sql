/* Copyright ScenPro, Inc, 2005
   ...
   $Header: /cvsshare/content/cvsroot/cdecurate/conf/template.load_tool_options.sql,v 1.12 2008-03-24 23:54:10 chickerura Exp $
...
MERGE INTO SBREXT.TOOL_OPTIONS_VIEW_EXT S
USING (		
SELECT 'CURATION' AS TOOL_NAME, 'EVS.VOCAB.2.EVSNAME' AS PROPERTY, 'GO - Gene Ontology' AS VALUE,'Store vocab name for the GO vocabulary'AS DESCRIPTION FROM DUAL 
...
UNION SELECT 'CURATION' AS TOOL_NAME, 'EVS.VOCAB.9.USEPARENT' AS PROPERTY, 'false' AS VALUE,'' AS DESCRIPTION FROM DUAL
