...
and de.CONTE_IDSEQ = (select CONTE_IDSEQ from SBR.CONTEXTS where name = 'NCIP');
...
and vm.CONTE_IDSEQ = (select CONTE_IDSEQ from SBR.CONTEXTS where name = 'NCIP');
...
and ac.CONTE_IDSEQ = (select CONTE_IDSEQ from SBR.CONTEXTS where name = 'NCIP');
