...
select dec.dec_id, c.name from sbr.data_element_concepts_view dec, sbr.contexts c
...
select de.cde_id, c.name from sbr.data_elements de, sbr.contexts c
...
select ac.public_id, c.name from sbr.ADMINISTERED_COMPONENTS ac, sbr.contexts c
