...
SELECT 'EVS' AS TOOL_NAME, 'URL' AS PROPERTY, 'http://lexevsapi51.nci.nih.gov/lexevsapi51' AS VALUE, 'Store evs alternate url specific to curation tool if needed' AS DESCRIPTION FROM DUAL
UNION
SELECT 'CURATION' AS TOOL_NAME, 'EVS.URL' AS PROPERTY, 'http://lexevsapi51.nci.nih.gov/lexevsapi51' AS VALUE, 'Store evs alternate url specific to curation tool if needed' AS DESCRIPTION FROM DUAL
)T 
