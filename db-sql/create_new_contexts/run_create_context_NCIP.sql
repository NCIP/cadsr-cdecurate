...
v_context_name varchar2(30) := '&1';
v_description varchar2(2000):= '&2';
...
select * from sbr.sc_contexts where lower(scl_name) like '%ncip%';

select * from sbr.contexts where lower(name) like '%ncip%';
