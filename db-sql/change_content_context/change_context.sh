...
$SQLPLUS_PATH/sqlplus $user/$pwd$HOST @change_user_ac_context.sql 'NIDA' 'NHLBI' '2013-05-22' '2013-05-23' DWARZEL
$SQLPLUS_PATH/sqlplus $user/$pwd$HOST @check_user_ac_context.sql 'NIDA' 'NHLBI' '2013-05-22' '2013-05-23' DWARZEL
