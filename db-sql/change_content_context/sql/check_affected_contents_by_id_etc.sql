...
and trunc(dec.date_created) <= to_date('2013-06-26', 'YYYY-MM-DD');
...
and trunc(de.date_created) <= to_date('2013-06-26', 'YYYY-MM-DD');
...
and trunc(vd.date_created) <= to_date('2013-06-26', 'YYYY-MM-DD');
