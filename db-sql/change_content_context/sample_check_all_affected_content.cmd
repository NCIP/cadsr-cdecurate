...
%SQLPLUS_PATH% %user%/%pwd%%HOST% @check_all_user_ac_context.sql 'NCIP' 'NCIP' '2001-01-01' '2013-08-07' '%%' > check_all_ac_counts_NCIP.txt

%SQLPLUS_PATH% %user%/%pwd%%HOST% @check_all_user_ac_context.sql 'caBIG' 'caBIG' '2001-01-01' '2013-08-07' '%%' > check_all_ac_counts_caBIG.txt
