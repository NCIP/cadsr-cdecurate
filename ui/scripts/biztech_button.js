...
// $Header: /cvsshare/content/cvsroot/cdecurate/ui/scripts/biztech_button.js,v 1.7 2007-06-01 22:20:48 hegdes Exp $
...
document.write("a.biztech_button_l:link, a.biztech_button_l:visited{text-align:left;background:#7f7fad url("+loc+"biztech_button_l.gif) no-repeat right;color:#ffff99;text-decoration:none;border-color:black;border-style:solid;border-width:0px "+bd+"px 0px "+bd+"px;padding:0px 0px 0px 0px;cursor:hand;display:block;font-size:12pt;font-family:Arial, Helvetica, sans-serif;font-weight:bold;}");
document.write("a.biztech_button_l:hover, a.biztech_button_l:active{background:#ffff99 url("+loc+"biztech_button_l2.gif) no-repeat right;color: #3c0323;text-decoration:none;border-color:black;border-style:solid;border-width:0px "+bd+"px 0px "+bd+"px;padding:0px 0px 0px 0px;cursor:hand;display:block;font-size:12pt;font-family:Arial, Helvetica, sans-serif;font-weight:bold;}");
document.write("\n-->\n");
...
mainMenuItem("biztech_button_b1",".gif",30,78,loc+"../NCICurationServlet?reqType=getSearchFilter","","Search",2,2,"biztech_button_plain");
mainMenuItem("biztech_button_b2",".gif",30,78,"javascript:;","","Create",2,2,"biztech_button_plain");
mainMenuItem("biztech_button_b3",".gif",30,78,"javascript:;","","Edit",2,2,"biztech_button_plain");
mainMenuItem("biztech_button_b5",".gif",30,78,"javascript:;","","Options",2,2,"biztech_button_plain");
mainMenuItem("biztech_button_b6",".gif",30,78,"javascript:callHelp();","","Help",2,2,"biztech_button_plain");
...
startSubmenu("biztech_button_b2","biztech_button_menu",204);
