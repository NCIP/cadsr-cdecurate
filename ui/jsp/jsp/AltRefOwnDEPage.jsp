<!-- Copyright (c) 2006 ScenPro, Inc.
    $Header: /cvsshare/content/cvsroot/cdecurate/ui/jsp/jsp/AltRefOwnDEPage.jsp,v 1.10 2007-01-26 17:30:13 hegdes Exp $
    ...
    <tr>
      <td align="left" valign="top" colspan=2>
        <input type="button" name="btnUpdate" value="Update Attributes" style="width:170" 
              onClick="javascript:submitAltRefDE();"
  ...
  <table width="900" border=0>
    <col width="4%"><col width="95%">
      ...
      <th colspan=2 height="40"> <div align="left"> 
          <label><font size=4>Create<font color="#FF0000"> Alternate Names or Reference Docuemnts</font>
          </font></label>
     </div></th>
    </tr>
    <!-- alternate Names -->
  	<tr valign="bottom" height="40">
        ...
        <td><font color="#FF0000">Add </font>Alternate Name Attributes</td>
    </tr>
    <tr>
      <td align="left">&nbsp;</td>
      <td>
    ...
    <!-- Reference Documents -->
  	<tr valign="bottom" height="40">
      <td align=right><%=item++%>)</td>
      <td><font color="#FF0000">Add </font>Reference Document Attributes</td>
    </tr>
    <tr>
      <td align="left">&nbsp;</td>
      <td>
        <table width="90%" border="0">
          ...
          <tr valign="middle">
            <td colspan="3">
              <textarea name="txtRefName"  style="width:90%" rows=2   
