<!-- Copyright (c) 2006 ScenPro, Inc.
    $Header: /cvsshare/content/cvsroot/cdecurate/ui/jsp/jsp/CRFValueResults.jsp,v 1.10 2007-05-23 23:20:05 hegdes Exp $
...
%>
	...
	<body bgcolor="#FFFFFF" onLoad="setup();">
        ...
        &nbsp;&nbsp;     -->
						...
						&nbsp;&nbsp;
						<img name="Message" src="../../cdecurate/Assets/SearchMessage.gif" width="180" height="25" alt="WaitMessage" style="visibility:hidden;" valign="bottom">
					</td>
				</tr>
			</table>
			<br>
