<!-- Copyright (c) 2006 ScenPro, Inc.
    $Header: /cvsshare/content/cvsroot/cdecurate/ui/jsp/jsp/CRFValueResults.jsp,v 1.6 2007-01-26 17:30:13 hegdes Exp $
    ...
    <td align="left">
     <!-- <input type="button" name="CreateNewBtn" value="Create New" onClick="javascript:CreateNewSelection();" style="width: 100", "height: 30">
      ...
      <img name="Message" src="../../cdecurate/Assets/SearchMessage.gif" width="180"
        height="25" alt="WaitMessage" style="visibility:hidden;" valign="bottom">
    </td>
  </tr>
</table>
<br>
<table width="100%">
  <tr>
      <td><font size="4"><b>Search Results of <%=sLabelKeyword%></b></font></td>
     <td><div align="right"><font size="2"><%=nRecs%> Records Found</font></div></td>
  </tr>
</table>
  <table width="100%" border="1">
    <tr valign="middle">
      <th height="30"><img src="../../cdecurate/Assets/CheckBox.gif"></th>
      <th method="get"><a href="NCICurationServlet?reqType=doSortCDE&sortType=CRFValue"
              onClick=SetSortType("CRFValue");
              onHelp = "showHelp('Help.htm#searchResultsForm_sort'); return false">
              Values from CRF Question</a></th>
      <th method="get"><a href="NCICurationServlet?reqType=doSortCDE&sortType=value"
              onClick=javascript:SetSortType("value")
              onHelp = "showHelp('Help.htm#searchResultsForm_sort'); return false">
              Value Items</a></th>
      <th method="get"><a href="NCICurationServlet?reqType=doSortCDE&sortType=meaning"
              onClick=javascript:SetSortType("meaning")
              onHelp = "showHelp('Help.htm#searchResultsForm_sort'); return false">
              Value Meanings</a></th>
    </tr>
<%
...
%>
        <tr>
          ...
          <td width="100"><%=crfValue%></td>
          <td width="100"><%=PValue%></td>
          <td width="100"><%=PVMean%></td>
        </tr>
<%
	   }
%>
