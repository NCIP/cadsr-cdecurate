...
//System.out.println("===CreateDE, sMenuAction:"+sMenuAction+",sOriginAction:"+sOriginAction);             
...
//System.out.println("jsp  name type " + sPrefType);
 ...
 /*   String sPrefDEC = m_DE.getDE_DEC_PREFERRED_NAME();
    sPrefDEC = serUtil.parsedString(sPrefDEC);    //call the function to handle doubleQuote
  ...
  /*  String sPrefVD = m_DE.getDE_VD_PREFERRED_NAME();
    sPrefVD = serUtil.parsedString(sPrefVD);    //call the function to handle doubleQuote
...
//System.out.println("cs csi list " + vACCSIList.size());
  ...
  <table width="900"  border=0>
     ...
     <tr valign="middle"> 
      <th colspan=2 height="40"> <div align="left"> 
          <label><font size=4>Create New <font color="#FF0000">Data Element </font> <%if(sOriginAction.equals("CreateNewDEFComp")){%> Component <%}%>
          </font></label>
        </div></th>
    </tr>
