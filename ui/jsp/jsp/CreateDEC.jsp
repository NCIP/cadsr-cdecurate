<!-- Copyright (c) 2006 ScenPro, Inc.
    $Header: /cvsshare/content/cvsroot/cdecurate/ui/jsp/jsp/CreateDEC.jsp,v 1.20 2007-01-26 20:17:44 hegdes Exp $
...
<% } %>
  ...
  <table width="98%" border="0">
      ...
      <tr>
        <th colspan=2 height="30"><div align="left"><label>
          <font size=4>Create New <font color="#FF0000">Data Element Concept </font>
            <% if (sMenuAction.equals("NewDECVersion")) { %>Version
            <% } else if (sMenuAction.equals("NewDECTemplate")) { %>Using Existing
            <% } %>
          </font></label></div>
        </th>
      </tr>
...
<%}%>
      ...
      <tr height="25" valign="bottom">
        <td align=right><font color="#FF0000">* &nbsp;</font><%=item++%>)</td>
        <td> <font color="#FF0000">Update</font> Data Element Concept Short Name</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
...
%>
    ...
    <tr height="25" valign="bottom">
      <td align=right>&nbsp;<%=item++%>)</td>
      <td align=left><font color="#FF0000">Enter/Select </font>Effective End Date</td>
    </tr>         
    <tr>
      <td>&nbsp;</td>
      <td valign="top"> <p>
      ...
      <tr>        
        ...
        <td align=left>
          <table border=0 width=90%>
            <col width="2%"><col width="32%"><col width="15%"> <col width="32%"><col width="15%">
            <tr>
              <td colspan=3 valign=top>
...
<%                  }     %>
              ...
              <td colspan=2 valign=top>
                <select name="selCSI" size="5" style="width:100%" onChange="selectCSI();"
                    onHelp = "showHelp('Help_CreateDE.html#newDECForm_selCS'); return false">
                </select>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td align=center><input type="button" name="btnRemoveCS" value="Remove Item" style="width: 85", "height: 9" onClick="removeCSList();"></td>
              <td>&nbsp;&nbsp;Associated Classification Scheme Items</td>
              <td align=center><input type="button" name="btnRemoveCSI" value="Remove Item" style="width: 85", "height: 9" onClick="removeCSIList();"></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td colspan=2 valign=top>
...
%>	          	
    ...
    <tr height="25" valign="bottom">
      <td align=right>&nbsp; <%=item++%>)</td>
      <td align=left><font color="#FF0000"> Select </font>Data
            Element Concept Origin</td>
    </tr>    
...
<%		   } %>
    ...
    <tr height="25" valign="bottom">
      <td align=right>&nbsp;<%=item++%>)</td>
      <td align=left><font color="#FF0000">Create </font>Change Note </td>
    </tr>    
    ...
    <tr>
      ...
      <td height="35" valign="top">
        <textarea name="CreateChangeNote" cols="69"
          onHelp = "showHelp('Help_CreateDEC.html#newDECForm_CreateComment'); return false" rows="2"><%=sChangeNote%></textarea>
      </td>
    </tr>
    
    <tr height="25" valign="bottom">
      <td align=right>&nbsp; <%=item++%>)</td>
      <td align=left><font color="#FF0000"> <A HREF="javascript:SubmitValidate('validate')">
        Validate</A></font> the New Data Element Concept</td>
    </tr>    
