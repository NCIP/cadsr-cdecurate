...
//  System.out.println("createDEC jsp sLongName2: " + sLongName + " sName: " + sName);    
  ...
  <table width="98%" border="0">
      ...
      <tr>
        <th colspan=2 height="30">
          <div align="left"><label><font size=4>Create New <font color="#FF0000">Data
            Element Concept</font></font></label></div>
        </th>
      </tr>
