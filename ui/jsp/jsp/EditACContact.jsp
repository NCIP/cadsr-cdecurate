<!-- Copyright (c) 2006 ScenPro, Inc.
    $Header: /cvsshare/content/cvsroot/cdecurate/ui/jsp/jsp/EditACContact.jsp,v 1.10 2007-01-26 19:30:38 hegdes Exp $
    ...
    <tr>
      <td align="left" valign="top" colspan=2>
        <input type="button" name="btnUpdate" value="Update Attributes" style="width:170" 
              onClick="javascript:submitForm('updContact');">
          &nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <table width="98%" border=0>
    <col width="4%"><col width="95%">
      ...
      <th colspan=2 height="40"> <div align="left"> 
        <label><font size=4>Create<font color="#FF0000"> Contact</font> Attributes
        </font></label>
      </div></th>
    </tr>
    ...
    <tr height="25" valign="bottom">
        ...
        <td><font color="#FF0000">Create </font>Contact Rank Order (maximum 3 numbers)</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>
    ...
    <!-- select the contact type -->
      ...
      <td>
      	<table width="100%" border="0">
      		<col width="4%"><col width="65%"><col width="30%">
		  <%if(selType.equals("Person")) {%> <!-- start if person selected -->
		    <tr height="25" valign="bottom">
      			<td>&nbsp;</td>
		        <td colspan=2>Select Person Name</td>
		    </tr>
		    <tr> 
      		  <td>&nbsp;</td>
		      <td valign="top">
		...
		%>
		          	<option value="<%=ctPer%>" selected="selected"><%=sName%></option>
		<% 		  } else { %>
		...
		%>
					    <option value="<%=sID%>" <%if(sID.equals(ctPer)){%> selected <%}%>><%=sName%></option>
		<%				  
					  }
					}
				  }
		%>          
		   ...
		   <%} else if (selType.equals("Organize")){%>  <!-- start if organization selected -->
		    <tr height="25" valign="bottom">
      			<td>&nbsp;</td>
		        <td colspan=2>Select Organization Name</td>
		    </tr>
		    <tr>
      		  <td>&nbsp;</td>
		      <td>
		...
		%>
		          	<option value="<%=ctOrg%>" selected="selected"><%=sName%></option>
		<% 		  } else { %>
		            <option value="" selected="selected"></option>
		<%          if (hOrg != null) 
		            {            
		...
		%>
						  <option value="<%=sID%>" <%if(sID.equals(ctOrg)) {%> selected <%}%>><%=sName%></option>
		<%				  
						}
					}
				  }
    ...
    <!-- select the Contact Role -->
  	<tr height="25">
        ...
        <td><font color="#FF0000">Select </font>Contact Role</td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td valign="top">
...
%>
				  <option value="<%=sRole%>" <%if(sRole.equals(ctRole)) {%> selected <%}%>><%=sRole%></option>
<%				  
				}
			}
%>          
    ...
    <tr valign="bottom" height="30">
      <td align=right><%=item++%>)</td>
      <td><font color="#FF0000">Create </font>Contact Communication Attributes</td>
    </tr>
    <tr>
      <td align="left">&nbsp;</td>
      <td>
        <table width="80%" border="0">
          ...
          <tr valign="bottom" height="25">
              <td colspan=2>Select Communication Type</td>
          </tr>
          <tr valign="middle">
            <td colspan=2>
...
<%          	if (hCommType != null) 
	            {            
					...
					while (enum1.hasMoreElements())
					{
					  ...
					  if (selCT == null) selCT = "";
%>
					  <option value="<%=sID%>" <%if(sID.equals(selCT)) {%>selected<%}%>><%=sID%></option>
<%				  
					}
				}
%>          
		  ...
		  <tr height="25" valign="bottom">
	        <td colspan=2>Create Call Order (maximum 3 numbers)</td>
		  </tr>
		  <tr>
	      	<td colspan=2>
		  ...
		  <tr height="25" valign="bottom">
	        <td colspan=2>Create Communication Information (maximum 255 characters)</td>
		  </tr>
		  <tr>
	      	<td colspan=2>
          ...
          <tr>
            <td align="left">Selected Communication Attributes</td>
            <td align="left">
              <input  type="button" name="btnUpdComm" value="Edit Item" 
                style="width:85,height:9" onClick="javascript:editCommune('edit');" disabled>&nbsp;&nbsp;&nbsp;
              <input  type="button" name="btnRemComm" value="Remove Item" 
                style="width:85,height:9" onClick="javascript:editCommune('remove');" disabled>&nbsp;&nbsp;&nbsp;
            </td>
          </tr>
          <tr>
            <td colspan="2">
                ...
                <tr>
                  <td>
                    <table width="99%" border="0">
                      <col width="2%"><col width="28%"><col width="15%"><col width="60%">
                      <tr valign="middle">
                        <th><%if (vDispComm.size() > 0){%>
                            <img id="altCheckGif" src="../../cdecurate/Assets/CheckBox.gif" border="0"> 
                          <% } %>
                        </th>
                        <th align="center"><b>Communication Type</b></th>
                        <th align="center"><b>Call Order</b></th>
                        <th align="center"><b>Communication Information</b></th>
                     </tr>
                    </table>
                  </td>
                </tr>
...
%>
                              ...
                              <td align="right" valign="top"><input type="checkbox" name="<%=ckName%>" 
                                size="5" onClick="javascript:enableCommButtons(checked);"></td>
                              <td valign="top"><%=cType%></td>
                              <td valign="top"><%=cOrd%></td>
                              <td valign="top"><%=cAdd%></td>
                          	</tr>  
<%          			  }
                      	} else {
%>
                          	<tr>
	                          <td align="right" valign="top"><input type="checkbox" name="" size="5"></td>
	                          <td valign="top"></td>
	                          <td valign="top"></td>
	                          <td valign="top"></td>
                          	</tr>  
<%					  	}  %>                    
    ...
    <!-- addressess -->
      ...
      <td align=right><%=item++%>)</td>
      <td><font color="#FF0000">Create </font>Contact Address Attributes</td>
    </tr>
    <tr>
      <td align="left">&nbsp;</td>
      <td>
        <table width="100%" border="0">
          ...
          <tr valign="bottom" height="25">
            <td colspan="2">Select Address Type</td>
          </tr>
          <tr valign="middle">
            <td colspan="2">
...
<%          	if (hAddrType != null) 
	            {            
					...
					while (enum1.hasMoreElements())
					{
					  ...
					  if (selAT == null) selAT = "";
%>
					  <option value="<%=sID%>" <%if(sID.equals(selAT)){%>selected<%}%>><%=sID%></option>
<%				  
					}
				}
%>          
          ...
          <tr valign="bottom" height="25">
              <td colspan="2">Create Primary Order (maximum 3 numbers)</td>
          </tr>
          <tr valign="middle">
            <td colspan="2">
          ...
          <tr height="30" valign="middle">
            <td align="left" colspan="3"><input type="button" name="btnAddAddr" value="Add Selection" style="width:100" onClick="javascript:editAddress('add');"></td>
          </tr>
          <tr><td height="12" valign="top"></tr>    
          <tr>
            <td>Selected Address Attributes</td>
            <td align="right">
              <input  type="button" name="btnUpdAddr" value="Edit Item" style="width:100" 
              	onClick="javascript:editAddress('edit');" disabled>&nbsp;&nbsp;&nbsp;
              <input  type="button" name="btnRemAddr" value="Remove Item" style="width:100" 
              	onClick="javascript:editAddress('remove');" disabled>&nbsp;&nbsp;&nbsp;
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <table width="100%" border="1">
                <tr>
                  <td>
                    <table width="99%" border="0">
                      <col width="2%"><col width="16%"><col width="8%"><col width="25%"><col width="14%"><col width="14%"><col width="10%"><col width="12%">
                      <tr valign="middle">
                        <th><%if (vDispAddr.size() > 0){%>
                            <img id="refCheckGif" src="../../cdecurate/Assets/CheckBox.gif" border="0"> 
                          <% } %>
                        </th>
                        <th align="center"><b>Address <br>Type</b></th>
                        <th align="center"><b>Primary <br>Order</b></th>
                        <th align="center"><b>Address</b></th>
                        <th align="center"><b>City</b></th>
                        <th align="center"><b>State/<br>Province</b></th>
                        <th align="center"><b>Country</b></th>       
                        <th align="center"><b>Postal <br>Code</b></th>       
                     </tr>
                    </table>
                  </td>
                </tr>
        ...
        %>
                    ...
                    <table width="100%" border="1">
                      <col width="2%"><col width="16%"><col width="8%"><col width="25%"><col width="14%"><col width="14%"><col width="10%"><col width="10%">
<%						if (vDispAddr.size() > 0) 
						{ 
  						  int ckCount = 0;
...
%>
                          	<tr>
                              <td align="right" valign="top"><input type="checkbox" name="<%=ckName%>" 
                                size="5" onClick="javascript:enableAddrButtons(checked);"></td>
                            <td valign="top"><%=aType%></td>
                            <td valign="top"><%=aOrd%></td>
                            <td valign="top"><%=aAdd%></td>
                            <td valign="top"><%=aCity%></td>
                            <td valign="top"><%=aState%></td>
                            <td valign="top"><%=aCntry%></td>
                            <td valign="top"><%=aZip%></td>
                          	</tr>  
<%          			  }
                      	} else {
%>
                          <tr>
                            <td valign="top"><input type="checkbox" name="" size="5"></td>
                            <td valign="top"></td>
                            <td valign="top"></td>
                            <td valign="top"></td>
                            <td valign="top"></td>
