<!-- Copyright (c) 2006 ScenPro, Inc.
    $Header: /cvsshare/content/cvsroot/cdecurate/ui/jsp/jsp/ValueMeaningDetail.jsp,v 1.6 2007-06-12 20:27:24 hegdes Exp $
										...
										<tr <% if (i%2 == 0) { %> class="rowColor" <% } %>>
											<td>
												<a href="javascript:deleteConcept('<%=i%>', '<%=cBean.getLONG_NAME()%>');" title="Remove Item">
													<img src="Assets/delete_white.gif" border="0" alt="Remove Item">
												</a>
												<% if (i != 0) { %>
												<a href="javascript:moveConcept('<%=i%>', '<%=VMForm.ACT_CON_MOVEUP%>');" title="Move Up">
													<img src="Assets/upArrow.gif" border="0" alt="Move Up">
												</a>
												<% } %>
												<% if (i != vmCon.size()-1) { %>
												<a href="javascript:moveConcept('<%=i%>', '<%=VMForm.ACT_CON_MOVEDOWN%>');" title="Move Down">
													<img src="Assets/downArrow.gif" border="0" alt="Move Down">
												</a>
												<% } %>
											</td>
											<td>
