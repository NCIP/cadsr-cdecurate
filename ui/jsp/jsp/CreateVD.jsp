...
// naming from here to 
 ...
 //System.out.println("create vd vRepQualifierNames.size(): " + vRepQualifierNames.size());  
  ...
  /*   String sRepTermPrimaryPN = "";
    if(sRepTermPrimary.length()>3)
      sRepTermPrimaryPN = sRepTermPrimary.substring(0,4);
    else
      sRepTermPrimaryPN = sRepTermPrimary; 
    ...
    if(sRepQualLN.length()>0 && sRepTermPrimary.length()>0)
      ...
      sRepTerm = sRepQualLN;
    else if(sRepTermPrimary.length()>0)
  ...
  //  Vector vPVIDList = (Vector)session.getAttribute("PVIDList");
  //  if (vPVIDList == null) vPVIDList = new Vector();
  ...
  //  System.out.println("cs size jsp " + vSelCSList.size());
 ...
 //System.out.println("create vd 01aa"); 
%>
...
<SCRIPT LANGUAGE="JavaScript">
  ...
  {
  <%
// System.out.println("create vd loadCSCSI"); 
    ...
    //  System.out.println(thisCSI.getCSI_NAME() + " : " + thisCSI.getCSI_LEVEL());
   %>
