			...
			<table width="100%" class="sidebarBGColor">
				...
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="keyword"
						size="22" style="width: 160" value="Right"
						onHelp="showHelp('html/Help_SearchAC.html#searchParmsForm_SearchBlocks',helpUrl); return false">
					</td>
				</tr>
				<tr>
...
<div id="col3">
	<div id="col3_content" class="clearfix">
		<form name="searchResultsForm" method="post"
			...
			<table border="0">
				<tr align="left">
					<td><s:url id="newVmFromVmConceptTableUrl" value="newVmFromVmConceptTable.jsp" />
						<sj:a id="newVmFromVmConceptAnchor" indicator="indicator2"
							href="%{newVmFromVmConceptTableUrl}" targets="newVmFromVmConceptTableDiv"
							button="true"
			...
			<table width="100%" border="1" valign="top">
				...
				<tr>
					...
					<td width="150px" valign="top">Right <br>
					</td>


					<td valign="top">2204868</td>

					<td valign="top">C25228</td>

					<td valign="top">Right; being or located on or directed toward
						the side of the body to the east when facing north.</td>
				...
				<tr>
					...
					<td width="150px" valign="top"><a
						href="javascript:showConceptInTree('CK1');"> Right </a> <br>
					...
					<td valign="top">Being or located on or directed toward the
						side of the body to the east when facing north.</td>
				...
				<tr>
					...
					<td width="150px" valign="top"><a
						href="javascript:showConceptInTree('CK2');"> Right </a> <br>
