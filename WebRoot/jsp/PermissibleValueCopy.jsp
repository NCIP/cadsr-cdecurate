...
<body onload="onLoad('<%=elmFocus%>');hideCloseButton(<%=isView%>);">
	<table width="100%" border="2" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td><jsp:include page="VDPVSTab.jsp" flush="true" />
				<div
				...
				<div style="display:none;">
					<input type="hidden" name="hideDatePick"
						oncalendar="appendDate(this.value);"> <input type="hidden"
						name="pageAction" value="nothing"> <input type="hidden"
						name="editPVInd" value="<%=sEditPV%>">
