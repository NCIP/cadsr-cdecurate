<!-- Copyright (c) 2006 ScenPro, Inc.
    $Header: /cvsshare/content/cvsroot/cdecurate/WebRoot/jsp/CreateDE.jsp,v 1.2 2007-09-19 16:59:34 hebell Exp $
...
%>
				...
				<tr>
					...
					<td height="24" valign="top">
						<input name="txtLongName" type="text" value="<%=sLongName%>" size="80" maxlength=255 onKeyUp="changeCountLN();" onHelp="showHelp('html/Help_CreateDE.html#newCDEForm_txtLongName'); return false">
						&nbsp;&nbsp;&nbsp;
						<font color="#666666">
				...
				<tr>
					...
					<td height="24" valign="top">
						<input name="txtPreferredName" type="text" value="<%=sName%>" size="80" maxlength=30 onKeyUp="changeCountPN();" <%if (sPrefType.equals("") || sPrefType.equals("SYS") || sPrefType.equals("ABBR")) {%> readonly <%}%>
							onHelp="showHelp('html/Help_CreateDE.html#newCDEForm_txtLongName'); return false">
						&nbsp;&nbsp;&nbsp;
						<font color="#666666">
...
%>
				...
				<tr>
					...
					<td valign="top">
						<input name="Version" type="text" value="<%=sVersion%>" size="5" maxlength=5 onHelp="showHelp('html/Help_CreateDE.html#newCDEForm_Version'); return false">
						&nbsp;&nbsp;&nbsp;
...
%>
				...
				<tr>
					...
					<td height="25" valign="top">
						<input type="text" name="EndDate" value="<%=sEndDate%>" size="12" maxlength=10 onHelp="showHelp('html/Help_CreateDE.html#newCDEForm_EndDate'); return false" size="20">
						...
						<table width=80% border="0">
							...
							<tr>
								<td height="30" valign="top" colspan=3>
									<select name="selCS" size="1" style="width:95%" valign="top" onChange="ChangeCS()" onHelp="showHelp('html/Help_CreateDE.html#newCDEForm_selCS'); return false">
										<option value="" selected></option>
  ...
  %>
								...
								<td height="30" valign="top" colspan=2>
									<select name="selCSI" size="5" style="width:95%" onChange="selectCSI();" onHelp="showHelp('html/Help_CreateDE.html#newCDEForm_selCS'); return false">
...
%>
					...
					<td colspan=1 valign=top>
						<select name="selOrderList" size="3" style="width:120" onChange="javascript:selectODEComp();" onHelp="showHelp('html/Help_CreateDE.html#newCDEForm_selOrderList'); return false">
